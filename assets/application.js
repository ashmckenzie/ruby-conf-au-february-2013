  ...
  window.Gloat.DeckKeyBindings = DeckKeyBindings = (function() {
    ...
    function DeckKeyBindings(deckViewModel) {
      ...
      Mousetrap.bind('left', function() {
        if (!this.deckViewModel.slideListVisible()) {
          return this.deckViewModel.gotoPreviousSlide();
        } else {
          return this.deckViewModel.gotoPreviousSlideList();
        }
      });
      Mousetrap.bind(['right', 'space'], function() {
        if (!this.deckViewModel.slideListVisible()) {
          ...
          return this.deckViewModel.gotoNextSlideList();
        }
      });
      Mousetrap.bind('enter', function() {
        if (this.deckViewModel.slideListVisible()) {
          return this.deckViewModel.slideListClick(this.deckViewModel.currentSlideList());
        }
      });
...
(function() {
  ...
  window.Gloat.DeckViewModel = DeckViewModel = (function() {
    ...
    function DeckViewModel(decksIndexPath, deck) {
      ...
      this.currentSlideList = ko.observable();
    ...
    DeckViewModel.prototype.gotoNextSlideList = function() {
      if (this.currentSlideList().number() < this.totalSlideNumber()) {
        this.currentSlideList(this.slides()[this.currentSlideListNumber()]);
        return this.scrollToSlideListCurrent(this.currentSlideList().number() - 1);
      }
    };
    ...
    DeckViewModel.prototype.gotoPreviousSlideList = function() {
      if (this.currentSlideList().number() > 1) {
        this.currentSlideList(this.slides()[this.currentSlideListNumber() - 2]);
        return this.scrollToSlideListCurrent(this.currentSlideList().number() - 1);
      }
    };

    DeckViewModel.prototype.currentSlideListNumber = function() {
      return this.currentSlideList().number();
    };

    DeckViewModel.prototype.loadSlide = function(number) {
      var currentSlide;
      this.previousSlide(this.currentSlide());
      currentSlide = this.slides()[number - 1];
      this.currentSlide(currentSlide);
      this.currentSlideList(currentSlide);
      if (this.slideListVisible()) {
        return this.scrollToSlideListCurrent(this.currentSlide().number() - 1);
      }
    };
    ...
    DeckViewModel.prototype.slideListClick = function(slide) {
      ...
      return self.deckViewModel.toggleSlideList(false);
    };
    ...
    DeckViewModel.prototype.scrollToSlideListCurrent = function(index) {
      var amount;
      if (index >= 0) {
